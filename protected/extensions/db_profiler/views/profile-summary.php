...
<table class="yiiLog" width="100%" cellpadding="2" style="border-spacing:1px;font:11px Verdana, Arial, Helvetica, sans-serif;background:#EEEEEE;color:#333;">
	<tr>
...
foreach($data as $index=>$entry)
{
	...
	<tr style="background:{$color}">
		<td style="background:{$color}; padding:8px;">{$proc}</td>
